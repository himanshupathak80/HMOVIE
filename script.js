...
fetch(json_url).then(Response => Response.json()).then((data) =>{
    ...
    play.addEventListener('click', ()=>{
        ...
        if (video.paused) {
            video.play();
            play.innerHTML = `play <i class="bi bi-pause-circle-fill"></i>`
        } else {
             play.innerHTML = `watch <i class="bi bi-play-circle-fill"></i>`
            video.pause();
        }
